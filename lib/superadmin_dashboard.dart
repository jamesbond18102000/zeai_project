...
class _SuperAdminDashboardState extends State<SuperAdminDashboard> {
  ...
  Future<void> fetchEmployeeName() async {
    ...
    try {
      final uri = Uri.parse(
        "https://zeai-project.onrender.com/api/employees/$employeeId",
      );
  ...
  Future<void> _fetchLeaveBalance() async {
    try {
      ...
      final url =
          "https://zeai-project.onrender.com/apply/leave-balance/$employeeId?year=$year";
    ...
    try {
      final response = await http.get(
        Uri.parse(
          ...
          "https://zeai-project.onrender.com/apply/pending-count?approver=$userRole&approverId=$employeeId",
        ),
      );
  ...
  Future<void> _deleteEmployeeComment(String id) async {
    try {
      final response = await http.delete(
        Uri.parse("https://zeai-project.onrender.com/review-decision/$id"),
      );
  ...
  Future<void> _showEmployeeComments() async {
    try {
      final response = await http.get(
        Uri.parse("https://zeai-project.onrender.com/review-decision"),
  ...
  Future<List<dynamic>> _fetchPendingRequests() async {
    try {
      final response = await http.get(
        Uri.parse("https://zeai-project.onrender.com/requests?status=pending"),
        headers: {"Accept": "application/json"},
      );
      if (response.statusCode == 200) {
  ...
  Future<void> _approveRequest(String requestId) async {
    try {
      final response = await http.post(
        Uri.parse(
          'https://zeai-project.onrender.com/requests/$requestId/approve',
        ),
  ...
  Future<void> _declineRequest(String requestId) async {
    try {
      final response = await http.post(
        Uri.parse(
          'https://zeai-project.onrender.com/requests/$requestId/decline',
        ),
        headers: {'Content-Type': 'application/json'},
        body: jsonEncode({
          'resolvedBy':
