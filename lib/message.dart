  ...
  Future<void> fetchEmployeeDetails() async {
    try {
      final response = await http.get(
        Uri.parse(
          "https://zeai-project.onrender.com/api/employees/${widget.employeeId}",
        ),
      );
    ...
    if (_msgController.text.isNotEmpty &&
      ...
      try {
        ...
        final response = await http.post(
          Uri.parse("https://zeai-project.onrender.com/notifications"),
                ...
                children: [
                  ...
                  CircleAvatar(
                    ...
                    backgroundImage:
                        ...
                        ? NetworkImage(
                            "https://zeai-project.onrender.com${employeeData!['employeeImage']}",
                          )
