...
class _EmployeeProfilePageState extends State<EmployeeProfilePage> {
  ...
  Future<void> fetchEmployee() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('https://zeai-project.onrender.com/profile/$employeeId'),
      );
  ...
  Future<void> updateEmployeeField(String field, String newValue) async {
    ...
    try {
      final url = Uri.parse(
        'https://zeai-project.onrender.com/requests/profile/$employeeId/request-change',
      );
  ...
  Future<void> _handleUpload(String docType) async {
    ...
    try {
      final uri = Uri.parse(
        "https://zeai-project.onrender.com/upload/$employeeId",
      );
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await http.post(
                Uri.parse(
                  'https://zeai-project.onrender.com/profile/$employeeId/experience',
                ),
                headers: {'Content-Type': 'application/json'},
            ...
            child: Column(
              ...
              children: [
                ...
                if (hasFile)
                  TextButton(
                    onPressed: () async {
                      final url = "https://zeai-project.onrender.com$filePath";
            ...
            onPressed: () async {
              ...
              try {
                final response = await http.put(
                  Uri.parse(
                    'https://zeai-project.onrender.com/profile/$employeeId/experience/${exp.id}',
                  ),
                  headers: {'Content-Type': 'application/json'},
