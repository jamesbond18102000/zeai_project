                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: pickedImageBytes != null
                          ...
                          : Image.network(
                              "https://zeai-project.onrender.com${emp["employeeImage"]}",
                              fit: BoxFit.cover,
                            ),
                    ),
                  ),
              ...
              onPressed: () async {
                try {
                  var request = http.MultipartRequest(
                    'PUT',
                    Uri.parse(
                      "https://zeai-project.onrender.com/api/employees/${idController.text}",
                    ),
                  );
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            final url = Uri.parse(
                              "https://zeai-project.onrender.com/apply/fetch/$empId",
                            );
                            try {
